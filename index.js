...
function getData() { var script = document.createElement("script");
  script.src = "http://api.forismatic.com/api/1.0/?method=getQuote&lang=en&format=jsonp&jsonp=updateDom"; document.getElementsByTagName("head")[0].appendChild(script);
}
